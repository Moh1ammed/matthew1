...
ماثيومحمدWRITING THE SOURCE BY : @M1_m2s

WRITING THE SOURCE BY : @M1_m2s
CH SOURCE : @BoTs0
...
function Run()
print('\27[93m>Developer:\27[39m'..' '..'@BoTs0')
end
------------------------boT ID   BY matthew1 ----------------------
...
local channel = ''..redis:get(matthew1..'Kpch1')..''
...
✓‏
‌‏]]
send(sudoed, 0, 1,iD_matthew1, 1, "md")
...
local url , res = https.request('https://api.telegram.org/bot'..matthew1_TOKEN..'/getChatAdministrators?chat_id='..msg.content_.text_..'')
local data = KPJS:decode(url)
if res == 400 then
...
redis:set(matthew1..'Kpch1',CH_BOT)
...
-------------------------------leave groups----------------------------------------------------------------------
if is_sudo(msg) and idf:match("-100(%d+)") and (text:match('^'..(redis:get(matthew1..'matthew1nams') or 'ماثيو')..' غادر$')) then
...
local user_info_ = redis:get(matthew1..'user:Name' .. result.sender_user_id_)
local Usermatthew1 = user_info_
if user_info_ then
...
local hash = 'bot:vipmems:'
if result.id_ then
if redis:sismember(matthew1..hash, result.id_) then
...
local user_info_ = redis:get(matthew1..'user:Name' .. ap[2])
local Usermatthew1 = user_info_
if user_info_ then
local hash = 'bot:vipmems:'
if redis:sismember(matthew1..hash, ap[2]) then
send(msg.chat_id_, msg.id_, 1,'👨‍✈️┊ العضو » (['..Usermatthew1..'])\n⚠️┊ مرفوع مميز عام سابقا\n✓‏', 1, 'md')
else
...
local hash = 'bot:vipmems:'
if result.id_ then
if not redis:sismember(matthew1..hash, result.id_) then
...
if user_info_ then
local hash = 'bot:vipmems:'
if not redis:sismember(matthew1..hash, ap[2]) then
send(msg.chat_id_, msg.id_, 1,'👨‍✈️┊ العضو » (['..Usermatthew1..'])\n⚠️┊ تم تنزيله مميز عتم سابقا\n‏', 1, 'md')
else
...
function promote_by_username(extra, result, success)
if result.id_ then
if redis:sismember(matthew1..'bot:vipmem:'..msg.chat_id_, result.id_) then
texts = '👨‍✈️┊ العضو » ([@'..ap[2]..'])\n⚠️┊ مرفوع مميز سابقا\n✓'
else
...
local Usermatthew1 = user_info_
if user_info_ then
if redis:sismember(matthew1..'bot:vipmem:'..msg.chat_id_, ap[2]) then
texts = '👨‍✈️┊ العضو » (['..Usermatthew1..'])\n⚠️┊ مرفوع مميز سابقا\n✓'
else
...
local Usermatthew1 = user_info_
if user_info_ then
local k1 = not redis:sismember(matthew1..'bot:owners:'..msg.chat_id_, result.sender_user_id_)
local k2 = not redis:sismember(matthew1..'bot:momod:'..msg.chat_id_, result.sender_user_id_)
local k3 = not redis:sismember(matthew1..'bot:vipmem:'..msg.chat_id_, result.sender_user_id_)
...
function delallrtb(extra, result, success)
if result.id_ then
local k1 = not redis:sismember(matthew1..'bot:owners:'..msg.chat_id_, result.id_)
local k2 = not redis:sismember(matthew1..'bot:momod:'..msg.chat_id_, result.id_)
local k3 = not redis:sismember(matthew1..'bot:vipmem:'..msg.chat_id_, result.id_)
if k1 and k2 and k3 then
send(msg.chat_id_, msg.id_, 1, '👨‍✈️┊ العضو » ([@'..ap[2]..'])\n⚠️┊ لا توجد لديه رتبه\n✓‏', 1, 'md')
else
...
local Usermatthew1 = user_info_
if user_info_ then
local k1 = not redis:sismember(matthew1..'bot:owners:'..msg.chat_id_, ap[2])
local k2 = not redis:sismember(matthew1..'bot:momod:'..msg.chat_id_, ap[2])
local k3 = not redis:sismember(matthew1..'bot:vipmem:'..msg.chat_id_, ap[2])
if k1 and k2 and k3 then
send(msg.chat_id_, msg.id_, 1, '👨‍✈️┊ العضو » (['..Usermatthew1..'])\n⚠️┊ لا توجد لديه رتبه\n✓‏', 1, 'md')
else
...
local Usermatthew1 = user_info_
if user_info_ then
local k1 = not redis:sismember(matthew1..'bot:keed:'..msg.chat_id_, result.sender_user_id_)
local k2 = not redis:sismember(matthew1..'bot:muted:'..msg.chat_id_, result.sender_user_id_)
local k3 = not redis:sismember(matthew1..'bot:banned:'..msg.chat_id_, result.sender_user_id_)
if k1 and k2 and k3 then
send(msg.chat_id_, msg.id_, 1, '👨‍✈️┊ العضو » (['..Usermatthew1..'])\n⚠️┊ لا توجد لديه قيـــــــود\n✓‏', 1, 'md')
else
HTTPS.request('https://api.telegram.org/bot'..matthew1_TOKEN..'/restrictChatMember?chat_id=' ..msg.chat_id_.. '&user_id=' ..result.sender_user_id_..'&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True')
redis:srem(matthew1..'bot:keed:'..msg.chat_id_, result.sender_user_id_)
redis:srem(matthew1..'bot:muted:'..msg.chat_id_, result.sender_user_id_)
redis:srem(matthew1..'bot:banned:'..msg.chat_id_, result.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '👨‍✈️┊ العضو » (['..Usermatthew1..'])\n⚠️┊ تم رفع القيود عنه \n✓‏', 1, 'md')
end
end
end
...
function delallrtb(extra, result, success)
if result.id_ then
local k1 = not redis:sismember(matthew1..'bot:keed:'..msg.chat_id_, result.id_)
local k2 = not redis:sismember(matthew1..'bot:muted:'..msg.chat_id_, result.id_)
local k3 = not redis:sismember(matthew1..'bot:banned:'..msg.chat_id_, result.id_)
if k1 and k2 and k3 then
send(msg.chat_id_, msg.id_, 1, '👨‍✈️┊ العضو » ([@'..ap[2]..'])\n⚠️┊ لا توجد لديه قيـــــــود\n✓‏', 1, 'md')
else
HTTPS.request('https://api.telegram.org/bot'..matthew1_TOKEN..'/restrictChatMember?chat_id=' ..msg.chat_id_.. '&user_id=' ..result.id_..'&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True')
...
local Usermatthew1 = user_info_
if user_info_ then
local k1 = not redis:sismember(matthew1..'bot:keed:'..msg.chat_id_, ap[2])
local k2 = not redis:sismember(matthew1..'bot:muted:'..msg.chat_id_, ap[2])
local k3 = not redis:sismember(matthew1..'bot:banned:'..msg.chat_id_, ap[2])
if k1 and k2 and k3 then
send(msg.chat_id_, msg.id_, 1, '👨‍✈️┊ العضو » (['..Usermatthew1..'])\n⚠️┊ لا توجد لديه قيـــــــود\n✓‏', 1, 'md')
else
HTTPS.request('https://api.telegram.org/bot'..matthew1_TOKEN..'/restrictChatMember?chat_id=' ..msg.chat_id_.. '&user_id=' ..ap[2]..'&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True')
redis:srem(matthew1..'bot:keed:'..msg.chat_id_, ap[2])
...
return false end end
if text == 'بدء اللعبه'  and is_momod(msg.sender_user_id_, msg.chat_id_) and redis:get(matthew1..'kk1'..msg.sender_user_id_..''..msg.chat_id_..'') then
...
return false end
if text then
local matthew11 = redis:get(matthew1..'kk11'..msg.chat_id_..'')
if matthew11 == 'kkk' then
if text == 'موسى' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
...
if text then
local matthew11 = redis:get(matthew1..'kk111'..msg.chat_id_..'')
if matthew11 == 'kkkk' then
if text == 'ليبيا' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
redis:set(matthew1..'kk1111'..msg.chat_id_..'','mm')
 return false end end end
if text then
local matthew11 = redis:get(matthew1..'kk1111'..msg.chat_id_..'')
if matthew11 == 'mm' then
if text == 'طياره' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
redis:set(matthew1..'w1'..msg.chat_id_..'','q1')
 return false end end end
if text then
local matthew11 = redis:get(matthew1..'w1'..msg.chat_id_..'')
if matthew11 == 'q1' then
if text == '😝' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
redis:set(matthew1..'w2'..msg.chat_id_..'','q2')
 return false end end end
if text then
local matthew11 = redis:get(matthew1..'w2'..msg.chat_id_..'')
if matthew11 == 'q2' then
if text == 'شرطي' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
redis:set(matthew1..'w9'..msg.chat_id_..'','q9')
 return false end end end
if text then
local matthew11 = redis:get(matthew1..'w9'..msg.chat_id_..'')
if matthew11 == 'q9' then
if text == '😄' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
redis:set(matthew1..'w4'..msg.chat_id_..'','q4')
 return false end end end
if text then
local matthew11 = redis:get(matthew1..'w4'..msg.chat_id_..'')
if matthew11 == 'q4' then
if text == 'كوريا' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
return false end end end
if text then
local matthew11 = redis:get(matthew1..'w5'..msg.chat_id_..'')
if matthew11 == 'q5' then
if text == 'ملاك' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
redis:set(matthew1..'w6'..msg.chat_id_..'','q6')
 return false end end end
if text then
local matthew11 = redis:get(matthew1..'w6'..msg.chat_id_..'')
if matthew11 == 'q6' then
if text == 'شباك' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
return false end end end
if text then
local matthew11 = redis:get(matthew1..'w7'..msg.chat_id_..'')
if matthew11 == 'q7' then
if text == 'جميل' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
return false end end end
if text then
local matthew11 = redis:get(matthew1..'w8'..msg.chat_id_..'')
if matthew11 == 'q8' then
if text == 'كهوه' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
sleep(1.5)
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n( ن ،ص، و، ك، د)',1, 'md')
redis:set(matthew1..'w9o'..msg.chat_id_..'','q9o')
 return false end end end
if text then
local matthew11 = redis:get(matthew1..'w9o'..msg.chat_id_..'')
if matthew11 == 'q9o' then
if text == 'صندوك' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(matthew1..'w9o'..msg.chat_id_..'')
sleep(1.5)
...
redis:set(matthew1..'w00'..msg.chat_id_..'','q00')
 return false end end end
if text then
local matthew11 = redis:get(matthew1..'w00'..msg.chat_id_..'')
if matthew11 == 'q00' then
if text == 'مريض' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
...
redis:set(matthew1..'a15'..msg.chat_id_..'','s15')
 return false end end end
if text then
local matthew11 = redis:get(matthew1..'a15'..msg.chat_id_..'')
if matthew11 == 's15' then
if text == 'قرنابيط' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(matthew1..'a15'..msg.chat_id_..'')
sleep(1.5)
local keep00 = {'😔😔😔😔😔😔😔☺️😔😔😔😔😔'}
send(msg.chat_id_, 0, 1, '•ارسل الاسمايل المختلف \n*('..keep00[math.random(#keep00)]..')*',1, 'md')
redis:set(matthew1..'a26'..msg.chat_id_..'','s26')
return false end end end
if text then
local matthew11 = redis:get(matthew1..'a26'..msg.chat_id_..'')
if matthew11 == 's26' then
if text == '☺️' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(matthew1..'a26'..msg.chat_id_..'')
sleep(1.5)
local keepp = {'ط - م - ي','ي ,م ,ط'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keepp[math.random(#keepp)]..')*',1, 'md')
redis:set(matthew1..'a99'..msg.chat_id_..'','s99')
 return false end end end
if text then
local matthew11 = redis:get(matthew1..'a99'..msg.chat_id_..'')
if matthew11 == 's99' then
if text == 'مطي' then
redis:incr(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(matthew1..'a99'..msg.chat_id_..'')
return false end end end
-----------------------------------------------------------------------------
if text == 'نقاطي' then
send(msg.chat_id_, msg.id_, 1, '💬┊ عدد نقاطك » *('..tonumber(redis:get(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'') or 0 )..')*',1, 'md')
return false end
if text == 'بيع نقاطي' then
local user_info_ = redis:get(matthew1..'user:Name' .. msg.sender_user_id_)
local Usermatthew1 = user_info_
if user_info_ then
local numkep = tonumber(redis:get(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'') or 0 )
if numkep == 0 then
...
redis:set(matthew1..'karrar1'..msg.sender_user_id_..''..msg.chat_id_..'','karrar2')
send(msg.chat_id_, msg.id_, 1, keep,1, 'md')
return false end end end
if text then
local matthew11 = redis:get(matthew1..'karrar1'..msg.sender_user_id_..''..msg.chat_id_..'')
if matthew11 == 'karrar2' then
if text == '1' then
if redis:sismember(matthew1..'bot:vipmem:'..msg.chat_id_, msg.sender_user_id_) then
send(msg.chat_id_, msg.id_, 1,'⚠️┊ عذرا انت مرفوع مميز سابقا\n✓', 1, 'md')
redis:del(matthew1..'karrar1'..msg.sender_user_id_..''..msg.chat_id_..'')
else
local numkep = tonumber(redis:get(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'') or 0 )
if numkep < tonumber(redis:get(matthew1.."matthew1_OO0" .. msg.chat_id_) or 100 )  then
send(msg.chat_id_, msg.id_, 1, '®️┊عذرا نقاطك اقل من '..tonumber(redis:get(matthew1.."matthew1_OO0" .. msg.chat_id_) or 100 )..'\n💬┊لا تستطيع تحويلهم لعضو مميز\n✓',1, 'md')
redis:del(matthew1..'karrar1'..msg.sender_user_id_..''..msg.chat_id_..'')
return false end
if numkep > tonumber(redis:get(matthew1.."matthew1_OO0" .. msg.chat_id_) or 100 )  then
send(msg.chat_id_, msg.id_, 1, '🎰┊مبروك عزيزي\n🎧┊تم رفعك عضو مميز\n ✓',1, 'md')
redis:sadd(matthew1..'bot:vipmem:'..msg.chat_id_, msg.sender_user_id_)
redis:del(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
redis:del(matthew1..'karrar1'..msg.sender_user_id_..''..msg.chat_id_..'')
...
local matthew1 = { string.match(text, "^(ضع شرط البيع) (%d+)$")}
send(msg.chat_id_, msg.id_, 1, "®️┊تم وضع عدد نقاط البيع\n🎵┊الان يمكن للعضو بيع نقاط اللعبه\n🌋┊اذا كان عدد نقاطه اكبر من~ *"..matthew1[2].."*\n✓",1, 'md')
redis:set(matthew1.."matthew1_OO0" .. msg.chat_id_, matthew1[2])
return false end
-------------------------------------------------------------------------------------
...
if not redis:get(matthew1..'Kpch1') then
send(msg.chat_id_, msg.id_, 1, '™️┊ لم يتم وضع القناة\n📌┊ لتعين  القناة ارسل .....\n⚠️┊ `تعين قناة الاشتراك `\n➖', 1, 'md')
return false 
end
if redis:get(matthew1..'Kpch1') then
...
💠┊مرحبا انا بوت اسمي *(]]..(redis:get(matthew1..'matthew1nams') or 'ماثيو')..[[)🗼*
...
if not redis:get(matthew1.."bot:group:link"..msg.chat_id_) then
local getlink = 'https://api.telegram.org/bot'..matthew1_TOKEN..'/exportChatInviteLink?chat_id='..msg.chat_id_
local req = https.request(getlink)
local link = KPJS:decode(req)
if link.ok == true then 
redis:set(matthew1.."bot:group:link"..msg.chat_id_,link.result)
end
end
local lik_1 = redis:get(matthew1.."bot:group:link"..msg.chat_id_)
if lik_1 then
link = lik_1 
else
link = link.result
end
send(Kp_Owner,0, 1,"- *تم اضافه مجموعه* »\nﮧ┉┉┉┉┉┉┉┉┉\n‏🔱┊ المدير ≈ [" .. owner .. "]\n🔰┊ ["..title_name(msg.chat_id_).."]("..(link or "t.me/BoTs0")..")\n🚫┊ *ايدي المجموعه* »\n📉┊ﮧ "..msg.chat_id_.."\n*«معلومات عن المطور»*\nﮧ┉┉┉┉┉┉┉┉┉\n🌀┊ ايديه ≈ (" .. msg.sender_user_id_ .. ")\n🚫┊ اسمه ≈ " ..result.first_name_.. "\n️⚠️┊ معرفه ≈ [" .. username .. "]\n✓", 1, "md")
redis:set(matthew1.."bot:enable:" .. msg.chat_id_, true)
...
send(v,0, 1,"- *تم تعطيل مجموعه* »\nﮧ┉┉┉┉┉┉┉┉┉\n‏🔱┊ المدير ≈ " .. owner .. "\n🔰┊ الرابط ≈ [اضغـط هنـا](" .. (redis:get(matthew1.."bot:group:link"..msg.chat_id_) or "https://t.me/BoTs0") .. ")\n🔅┊* اسم المجموعه* »\n👨🏼┊ﮧ "..title_name(msg.chat_id_).."\n🚫┊ *ايدي المجموعه* »\n📉┊ﮧ "..msg.chat_id_.."\n*«معلومات عن المطور»*\nﮧ┉┉┉┉┉┉┉┉┉\n🌀┊ ايديه ≈ (" .. msg.sender_user_id_ .. ")\n🚫┊ اسمه ≈ " .. fname .. " " .. lname .. "\n️⚠️┊ معرفه ≈ [" .. username .. "]\n‏", 1, "md")
end
...
local num_keep = (tonumber(redis:get(matthew1.."incr_msg"..result.id_..""..msg.chat_id_.."") or 0 ))
local msgs = (tonumber(redis:get(matthew1.."msgs:"..result.id_..":"..msg.chat_id_) or  0))
...
local Usermatthew1 = user_info_
if user_info_ then
send(msg.chat_id_, msg.id_, 1, "•اهلا ~ ["..Usermatthew1.."]\n🎧» ايديك  (`"..msg.sender_user_id_.."`)\n✓", 1, "md")
return false end end
-------------------RETBA-------------------------
...
if not redis:get(matthew1..'lock:add'..msg.chat_id_) then
local num_keep = tonumber(redis:get(matthew1..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'') or 0 )
local msgs = tonumber(redis:get(matthew1.."msgs:"..msg.sender_user_id_..":"..msg.chat_id_))
...
local num_keep = (tonumber(redis:get(matthew1.."incr_msg"..result.sender_user_id_..""..msg.chat_id_.."") or 0 ))
local msgs = (tonumber(redis:get(matthew1.."msgs:"..result.sender_user_id_..":"..msg.chat_id_) or 0 ))
...
local matthew1_info = "🎟┊ ايديه  » `" .. result.sender_user_id_ .. "`\n👤┊ جهاته  »   "..Kpcontact.."\n🔆┊ نقاطه  »   "..num_keep.."\n🌐┊ تفاعله »  " .. KP_TM_NM(msgs) .. "\n✉️┊ رسائله » " .. msgs .. "\n📌┊ موقعه » " .. matthew13 .. "\n‏┄┄┄┄┄┄┄┄┄┄┄┄"
send(msg.chat_id_, result.id_, 1, matthew1_info, 1, "md")
end
...
redis:setex(matthew1..'botts:namess'..msg.sender_user_id_,698,true)
...
redis:setex(matthew1.."bot:group:link" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 1200, true)
end
...
local botnamess = redis:get(matthew1.."matthew1nams") or "ماثيو"
...
------------------SOURCE matthew1---------------------------------------------------
if text:match("^سورس$") or text:match("^السورس$") or text:match("^مطور السورس$") or text:match("^ياسورس$") or  text:match("^سورس ماثيو$") or text:match("^اريد سورس$") then
if not redis:get(matthew1..'lock:add'..msg.chat_id_) then
local text =  [[
‏
‏
🔍┊ *اهلا بك في سورس ماثيو❗️
...
local OwnerKP_ = redis:get(matthew1.."Bot:KpOwnerBot")
local user_info_ = redis:get(matthew1.."user:Name")
local Usermatthew1 = user_info_
if user_info_ then
if not redis:get(matthew1..'lock:add'..msg.chat_id_) then
if not is_momod(msg.sender_user_id_, msg.chat_id_)then
...
local kpmonshis = redis:scard(matthew1.."bot:monshis:" .. chattid) or "0"
local kpbanned = redis:scard(matthew1.."bot:banned:" .. chattid) or "0"
local kpowners = redis:scard(matthew1.."bot:owners:" .. chattid) or "0"
local kpmuted = redis:scard(matthew1.."bot:muted:" .. chattid) or "0"
local kpkeed = redis:scard(matthew1.."bot:keed:" .. chattid) or "0"
local kpmomod = redis:scard(matthew1.."bot:momod:" .. chattid) or "0"
local kpvipmem = redis:scard(matthew1.."bot:vipmem:" .. chattid) or "0"
if not redis:get(matthew1.."bot:group:link"..chattid) then
local getlink = 'https://api.telegram.org/bot'..matthew1_TOKEN..'/exportChatInviteLink?chat_id='..chattid
local req = https.request(getlink)
local link = KPJS:decode(req)
if link.ok == true then 
redis:set(matthew1.."bot:group:link"..chattid,link.result)
end
end
local lik_1 = redis:get(matthew1.."bot:group:link"..chattid)
if lik_1 then
link = lik_1 
else
link = link.result
end
send(msg.chat_id_, msg.id_, 1, "🕴┊ المدير » ["..owner.."]\n🥈┊ﮧ ["..title_name(chattid).."]("..(link or "t.me/BoTs0")..")\n©️┊ عدد المــــدراء   » *"..kpowners.."*\n©️┊ عدد المنشئين   » *"..kpmonshis.."*\n🔆┊ عدد الادمنيـــه   » *"..kpmomod.."*\n🔰┊ عدد المكتومين  » *"..kpmuted.."*\n®️┊ عدد المحظورين » *"..kpbanned.."*\n®️┊ عدد المقيديــن   » *"..kpkeed.."*\n🗯┊ عدد المميزيـــن  » *"..kpvipmem.."*\n💠┊ﮧ `"..chattid.."`\n🏮┊ المطور » ["..sudo.."]\n✓", 1,"md")
end
tdcli_function ({
ID = "GetChannelFull",
...
--------------------------------------------------------
if text == ''..(redis:get(matthew1..'matthew1nams') or 'ماثيو')..' هينه' or text == ''..(redis:get(matthew1..'matthew1nams') or 'ماثيو')..' رزله' then
...
--------------------------------------------------------------------------------------------
if text == ''..(redis:get(matthew1..'matthew1nams') or 'ماثيو')..' بوسه' or text == ''..(redis:get(matthew1..'matthew1nams') or 'ماثيو')..' مصه' then
function reep22(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(matthew1_SUDO) then
...
if not redis:get(matthew1..'lock:add'..msg.chat_id_) then
local matthew1 = {'اسمي '..(redis:get(matthew1..'matthew1nams') or 'ماثيو')..' 😌👌','تره اسمي '..(redis:get(matthew1..'matthew1nams') or 'ماثيو')..' يالجريذي ☹️😹'  }
send(msg.chat_id_, msg.id_, 1,''..matthew1[math.random(#matthew1)]..'', 1, 'md')
end
end
-----------------------------------------
if text == ''..(redis:get(matthew1..'matthew1nams') or 'ماثيو')..'' then
if not redis:get(matthew1..'lock:add'..msg.chat_id_) then
local matthew1 = {'اي نعم اني '..(redis:get(matthew1..'matthew1nams') or 'ماثيو')..' 🍃😐','اهو اجوي الملطلطين 😹😪','كافي تره كرهت اسمي 💔😠'}
send(msg.chat_id_, msg.id_, 1,''..matthew1[math.random(#matthew1)]..'', 1, 'md')
end
end
-------------------------------------------------
