...
local Ayatol_Korsi = "matthew develop source matthew1 language lua "
...
------------------------------------------------
local matthew1EN = function(msg)     
            if is_leaderid(msg.sender_user_id_) then
                   matthew11  = "SUDO BOT "
            elseif is_sudoid(msg.sender_user_id_) then
                    matthew11 = "SUDO ✔️"
            elseif is_admin(msg.sender_user_id_) then      
                    matthew11 = "ADMIN  IN BOT ♣️"
            elseif is_owner(msg.sender_user_id_, msg.chat_id_) then
                    matthew11 = "OWNER 🎶"
            elseif is_momod(msg.sender_user_id_, msg.chat_id_) then
                matthew11 = "ADMIN IN GP 🎵"
            elseif is_vipmem(msg.sender_user_id_, msg.chat_id_) then
                   matthew11 = "VIP MEMBER 🔇"
            else
                  matthew11 = "MEMBER ONLY 🔕"
            end
return matthew11
end
--------------------------------------------
    ...
    if database:get("autoleave") == "On" then
      ...
      if id:match("-100(%d+)") and database:get("lefting" .. msg.chat_id_) then
        if not database:get("bot:enable:" .. msg.chat_id_) and not database:get("bot:charge:" .. msg.chat_id_) then
          ...
          local v = tonumber(bot_owner)
          send(v, 0, 1, "✺⇣ تم ممغادرةه المجموعــه\n⇨ اسم المجموعه : " .. (chat and chat.title_ or "---") .. "\n⇨ ايدي المجموعه : " .. msg.chat_id_, 1, "html")
          database:srem("bot:groups", msg.chat_id_)
...
send(msg.chat_id_, msg.id_, 1,'🔘┇لايوجد رد ',  1, "html")
else
...
send(msg.chat_id_, msg.id_, 1, "🔘┇الان ارسل جواب الرد" ,  1, "md")
return false
end
...
send(msg.chat_id_, msg.id_, 1, '📥┇تم اضافة الرد بنجاح الرد*('..database:get('replay1'..msg.sender_user_id_)..')*\n',  1, "md")
...
send(msg.chat_id_, msg.id_, 1, "❇️┇ارسل گلمة الرد\n",1, "md")
return false
end
end
--------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, 1, "🗑┇ارسل الرد الان \n",1, "md")
return false
end
end
----------------------------------------------------------------------------------
...
if #rrrd==0 then
send(msg.chat_id_, msg.id_, 1, "❌┇لاتوجد ردود \n",1, "md")
else
for i=1, #rrrd do 
database:hdel('replay:'..msg.chat_id_,rrrd[i])
 end
end
send(msg.chat_id_, msg.id_, 1, "🗑┇تم حذف جميع الردود\n",1, "md")
return false
end
end
------------------------------------------------------------------------------------
            ...
            local demotevip_by_id = function(extra, result)
              if result.id_ then
                ...
                if not database:sismember(hash, result.id_) then
                  ...
                  sendmen(msg.chat_id_, msg.id_, "👷‍┋ العضو @" .. te .. "\n🔍┋  ايديك ("..result.id_..")\n☑️┋ تم تنزيله من الاعضاء المميزين ✔️\n‏", 32, string.len(result.id_), result.id_)
                  end
                else
                  database:srem(hash, result.id_)
                  if database:get("lang:gp:" .. msg.chat_id_) then
        ...
        if text:match("^[Dd]elall (.*)$") and check_user_channel(msg) then
          local delall_by_id = function(extra, result)
            if result.id_ then
              ...
              if database:get("lang:gp:" .. msg.chat_id_) then
                sendmen(msg.chat_id_, msg.id_, "☑️┋  All Msgs from " .. te .. " Has Been Deleted 🚀 ", 15, string.len(tp), result.id_)
              else
...
-----------------------------------------------------------
    ...
    elseif msg_type == "MSG:Document" then
      if database:get("broadcast" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then
        ...
        if database:get("lang:gp:" .. msg.chat_id_) then
          send(msg.chat_id_, msg.id_, 1, "☑️┋  Your Message Was *Forwarded* to\n `" .. gps .. "` Groups 🎈", 1, "md")
        else
...
If You No Longer Want To Filter a Word, Send The /done Command !]], 1, "md")
        ...
        if database:get("broadcast" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then
          if text:match("^/[Cc]ancel$") or text:match("^الغاء$") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ The *Operation* Was Canceled ⚜️", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "🔰- <code>تم الغاء الامر بنجاح🎈 </code>", 1, "html")
            end
            database:del("broadcast" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
        ...
        if database:get("broadcast2" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then
          if text:match("^/[Cc]ancel$") or text:match("^الغاء$") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Your Message Was *Sent* to\n `" .. gps .. "` Groups 🎈", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ تم نشر رسالتك  في\n` " .. gps .. "` مجموعــه🎈  ", 1, "md")
            end
        ...
        if database:get("Getmenu" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) and msg.content_.text_:match("^(-%d+)$") then
          ...
          local getmenu = function(extra, result)
            ...
            elseif not database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  توجد مشكله في Api  🎈", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Technical *Problem* In Bot Api 🎈", 1, "md")
            end
          end
          tdcli_function({
...
> <b>Phone Number</b> : ]] .. phonenumbere, 1, "html")
        ...
        if database:get("bot:nerkh" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then
          ...
          if database:get("lang:gp:" .. msg.chat_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, "☑️┋ تم وضــع كليشه المطور 🎗", 1, "md")
          end
        end
        if not is_vipmem(msg.sender_user_id_, msg.chat_id_) then
        ...
        if is_admin(msg.sender_user_id_) and idf:match("-100(%d+)") and (text:match("^[Ll]eave$") or text:match("^مغادرة$")) then
          if database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "✺ *Bot Leaves This Group* ✞", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "✺↓ <b>تم ممغادرةه المجموعــه </b>♩†",  1, "html")
          end
          database:srem("bot:groups", msg.chat_id_)
          chat_leave(msg.chat_id_, bot_id)
        end
              ...
              if result.id_ then
                ...
                if not is_momod(result.id_, msg.chat_id_) then
                  if database:get("lang:gp:" .. msg.chat_id_) then
                    ...
                    sendmen(msg.chat_id_, msg.id_, "📋┇  العضو  " .. te .. "\n\n🗑┇ تم طرده بنجاح ", 32, string.len(tp), result.id_)
                  end
                  chat_kick(msg.chat_id_, result.id_)
                elseif database:get("lang:gp:" .. msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, "👷‍┋  You *Can not* Ban *Moderators* 📍 ", 1, "md")
                else
                  send(msg.chat_id_, msg.id_, 1, "❗️┇لايمكنك طرد او حظر او كتم الادمن والمدير", 1, "md")
                end
              elseif database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "➢ *User Not Found* ✞ ", 1, "md")
              else
...
--------------------------------------------------------------------------
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Gg]etid$") or text:match("^ ايديك$") and msg.reply_to_message_id_ ~= 0) and check_user_channel(msg) then
          local getid_by_reply = function(extra, result)
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "🎫┋  *User ID* : `" .. result.sender_user_id_ .. "`", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "🎫┋   ايديك : " .. result.sender_user_id_, 1, "md")
            end
          end
            ...
            local id_by_usernameen = function(extra, result)
              if result.id_ then
                ...
                if gpid:match("^(%d+)") then
                  if database:get("lang:gp:" .. msg.chat_id_) then
                    text = "☑️┋ <b>User</b> : @" .. ap[2] .. "\n⚙️┋ <b>ID</b> : <code>" .. result.id_ .. "</code>\n🎫┋ <b>Rank</b> : <b>" .. t .. "</b>"
                  else
                    text = "☑️┋ <b>المعرف</b> : @" .. ap[2] .. "\n⚙️┋ <b> ايديك</b>  : (" .. result.id_ .. ")\n🎫┋ <b>الرتبه</b>  : " .. t
                  end
                elseif database:get("lang:gp:" .. msg.chat_id_) then
                  text = "☑️┋ <b>Username</b> : @" .. ap[2] .. "\n⚙️┋ <b>ID</b> : <code>" .. result.id_ .. "</code>"
                else
                  text = "☑️┋ <b>المعرف</b> : @" .. ap[2] .. "\n⚙️┋ <b>  ايديك</b> : (" .. result.id_ .. ")"
                end
              elseif not result.id_ then
                if database:get("lang:gp:" .. msg.chat_id_) then
                  text = "☑️┋ Username is <b>not faund </b>  "
                else
                  text = "☑️┋ المعرف غير صحيح  "
                end
              end
              send(msg.chat_id_, msg.id_, 1, text, 1, "html")
            end
...
---------------------------------------------------------------------------------------------------------		
 ...
 --------------------------------------------------------------
		if (idf:match("-100(%d+)") or is_momod(msg.sender_user_id_, msg.chat_id_)) and text:match("^اسمي$") and msg.reply_to_message_id_ == 0 and check_user_channel(msg) then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b> Your Name</b> :\n <code> " .. name .. "</code>", 1, "html")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>اســمك </b> :\n<code> " .. name .. "</code> " , 1, "html")
            end
          end
...
--------------------------------------------		 
		...
		local get_me = function(extra, result)
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>your name</b> :\n<code> " .. name .. "</code>\n💲┋ <b>Your Rank</b> :\n <code>" .. matthew1EN(msg) .. "</code>", 1, "html")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>اســمك</b> :\n<code> " .. name .. "</code>\n💲┋ <b>رتبتـك </b> :\n <code>" .. tmmatthew1(msg) .. "</code>" , 1, "html")
            end
          end
		  getUser(msg.sender_user_id_, get_me)
         end		 
        ...
        if is_sudo(msg) and idf:match("-100(%d+)") and text:match("^[Ss]howprofilestatus (.*)$") and check_user_channel(msg) then
          ...
          if status[2] == "active" or status[2] == "جلب الصور" then
            if database:get("getpro:" .. msg.chat_id_) == "Active" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Get Profile photo is \n *Already Actived* 🐣", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تـم تفعيــل جلــب الصــور </b> 💯", 1, "html")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Get Profile photo has been \n Changed to *Active*🐥 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تـم تفعيــل جلــب الصــور </b> 💯", 1, "html")
              end
          ...
          if status[2] == "deactive" or status[2] == "جلب الصور" then
            if database:get("getpro:" .. msg.chat_id_) == "Deactive" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تـم تعطــيل جلــب الصــور </b> 💯", 1, "html")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
...
---------------------------------------------------------------------------------------		
    ...
    database:set('flood:time:'..msg.chat_id_,floodt[2])
                if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '☑️┋ Flood has been set : *'..floodt[2]..'*', 1, 'md')
       else 
         send(msg.chat_id_, msg.id_, 1, '☑️┋ <code>تــم وضـــــع  التكرار </code>: <b>'..floodt[2]..'</b>', 1, 'html')
end
	end-----------------------------------------------------------------------------------------------------
	end
	   ...
	   if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Ll]ock (.*)$") or text:match("^قفل (.*)$")) and check_user_channel(msg) then
          ...
          if lockpt[2] == "cmd" or lockptf[2] == "الاوامر" then
            if not database:get("bot:cmds" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Case of no answer has been *Enable* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الاوامر ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:cmds" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Case of no answer is *Already* enable 📍", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الاوامر ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if lockpt[2] == "bots" or lockptf[2] == "البوتات" then
            if not database:get("bot:bots:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock bots has been *Activated* 👾 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل البوتات ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏",  1, "md")
              end
              database:set("bot:bots:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock bots is *Already* enable 👾 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل البوتات ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if lockpt[2] == "flood" or lockptf[2] == "التكرار" then
            if not database:get("anti-flood:" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock flood has been *Activated* 🚀  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل التكرار ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("anti-flood:" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock flood is *Already* enable 🚀  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل التكرار✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if lockpt[2] == "pin" or lockptf[2] == "التثبيت" then
            if not database:get("bot:pin:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock pin has been *Activated* 🚏 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل التثبيت ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:pin:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock pin is *Already* enable 🚏 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل التثبيت ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and text:match("^[Ss]etwarn (%d+)$") and check_user_channel(msg) then
          ...
          if 2 > tonumber(warnmax[2]) or tonumber(warnmax[2]) > 30 then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "☑️┋ تم وضع التحذير : " .. warnmax[2] .. " ⚜️ ", 1, "md")
            end
          ...
          if status[2] == "mute" or status[2] == "بالكتم" then
            if database:get("warnstatus" .. msg.chat_id_) == "Muteuser" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "☑️┋ تم وضع التحذير بالكتم", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
          ...
          if status[2] == "remove" or status[2] == "بالطرد" then
            if database:get("warnstatus" .. msg.chat_id_) == "Remove" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "☑️┋ تم وضع تحذير بالطرد 🏌️ ", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Warning status has been Changed to *Remove User* ✞", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "☑️┋ تم وضع تحذير بالطرد🎋 ", 1, "md")
              end
...
----------------------------------------------------------------------------------------		
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and text:match("^[Ss]howidstatus (.*)$") and check_user_channel(msg) then
          ...
          if status[2] == "photo" or status[2] == " ايديك" then
            if database:get("getidstatus" .. msg.chat_id_) == "Photo" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋ Get id status is *Already* on Photo ✞", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "☑️┋ تم تفعيل  ايديك ✔️\n🔘┋رتبتك : "..tmmatthew1(msg).."\n‏", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋ Get ID status has been Changed to *Photo* ✞", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "☑️┋ تم تفعيل  ايديك ✔️\n🔘┋رتبتك : "..tmmatthew1(msg).."\n‏", 1, "md")
              end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and text:match("^[Ss]howidstatus (.*)$") and check_user_channel(msg) then
          ...
          if status[2] == "simple" or status[2] == " ايديك" then
            if database:get("getidstatus" .. msg.chat_id_) == "Simple" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋ Get ID status is *Already* on Simple 🏌️", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "☑️┋ تم تعطيل لايدي ✔️\n🔘┋رتبتك : "..tmmatthew1(msg).."\n‏", 1, "html")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋ Get ID status has been Change to *Simple* 🏌️", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "☑️┋ تم تعطيل لايدي ✔️\n🔘┋رتبتك : "..tmmatthew1(msg).."\n‏", 1, "md")
              end
          ...
          if status[2] == "الخروج التلقائي" or status[2] == "on" then
            if database:get("autoleave") == "On" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "☑️┋ تم تفعيل الخروج التلقائي🎐 ", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
          ...
          if status[2] == "الخروج التلقائي" or status[2] == "off" then
            if database:get("autoleave") == "Off" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "☑️┋ تم تعطيل الخروج التلقائي للبوت✞ ", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
...
-----------------------------------------------------------		
        if is_leader(msg) then
          ...
          if text:match("^[Ss]etnerkh$") or text:match("^ضع كليشه المطور$") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Plese Send your now 🎣 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ ارســل لــي كليــشه المطــور الان 🎗", 1, "md")
            end
        ...
        if (msg.sender_user_id_) then
          ...
          if text:match("^[Nn]erkh$") or text:match("^المطور$") then
            ...
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Bot not found 🎐", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, " ☑️┋ لم يتم وضع كليشه المطور", 1, "md")
            end
          end
        end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Ll]ink$") or text:match("^الرابط$")) and check_user_channel(msg) then
          ...
          if link then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>Group link</b> ⇩\n\n" .. link, 1, "html")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>رابط المجموعه</b>:🎗\n" .. link, 1, "html")
            end
          elseif database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "☑️┋ *Group link* is not set  \n Plese send command *Setlink* and set it✞", 1, "md")
          else
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and text:match("^[Ff]ilter (.*)$") and check_user_channel(msg) then
          ...
          elseif database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "☑️┋  Word `[" .. name .. "]` Can Not *Filtering* 🚀 ", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "☑️┋  الكلمه <b>[ " .. name .. " ]</b> \n لا استطيع منعها❌", 1, "html")
          end
        end
...
‏
		...
		if text:match("^السورس$") or text:match("^سورس$") or text:match("^ياسورس$") or  text:match("^سورس ماثيو$") or text:match("^اريد سورس$") then
            if not database:get('lock:add'..msg.chat_id_) then
   local text =  [[
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
☢┇كود الرن` killall screen && cd matthew1 && screen ./matthew1`
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🚯┇كود الحذف `rm -fr matthew1`
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 

📋• [مراسلة المطور](t.me/iiiizBoT)
📋• [مراسلة الدعم](https://t.me/joinchat/Hc-ZrVDBz6UO1BQ4bx4eLg)
]]
                send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end end																																											
...
📮┋معلومات البوت
📮┋عدد المشاهدات
📮┋تنضيف+عدد↭لحذف رسائل
📮┋ايدي المجموعه↭ لعرض الايدي
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🔘┋اوامر الرفع 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🚸┋رفع ادمن ⇜ لرفع العضو ادمن
🚸┋رفع مدير ⇜ لرفع العضو مدير
🚸┋رفع مطور ⇜ لرفع العضو مطور
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
🔘┋اوامر التنزيل
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🚸┋حذف ادمن⇜ لحذف الادمن 
🚸┋حذف مطور ⇜ لحذف المطور
🚸┋حذف مدير ⇜ لحذف المدير
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📥┋ضع تكرار + العدد
☑️┋ضع تكرار بالطرد
☑️┋ضع تكرار بالمسح
...
📜┋موقعي↭لعرض موقعك
📜┋تثبيت ↭ لتثبيت رساله
📜┋الغاء تثبيت↭الغاء تثبيت رساله
📜┋ضع كليشه المطور
📜┋تفعيل/تعطيل الايدي
📜┋مغادرة ↭ لممغادرةة البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
ch ↭ @BoTs0
]]
                send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
...
🚸┋الغاء العام ⇜ لـ الغاء الحظر عام
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🚷┋كتم ⇜ لكتم العضو
💯┋ الغاء كتم ⇜ لـ فتح كتم العضو
🚷┋كتم + ساعه ⇜ لكتم العضو بوقت
📛┋طرد ⇜ لطرد العضو من المجموعه
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
🚸┋استخدم مسح + الامر
🚸┋استخدم عرض + الامر
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
...
---------------------------------------------------------------------------------------------------------------------------  
	...
	if text:match("^تفعيل الترحيب$") and is_momod(msg.sender_user_id_, msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '☑️┋ تم ✅ تفعيل الترحيب 🎐', 1, 'md')
		 database:set("bot:welcome"..msg.chat_id_,true)
	end
	if text:match("^تعطيل الترحيب$") and is_momod(msg.sender_user_id_, msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '☑️┋ تم ✅ تعطيل الترحيب 🎈', 1, 'md')
		 database:del("bot:welcome"..msg.chat_id_)
	end
	...
	local welcome = {string.match(text, "^([Ss]etwelcome) (.*)$")} 
         send(msg.chat_id_, msg.id_, 1, '☑️┋ Welcome add:\n ............. :\n\n*'..welcome[2]..'*', 1, 'md')
 ...
 local welcome = {string.match(text, "^(وضع ترحيب) (.*)$")}
         send(msg.chat_id_, msg.id_, 1, '☑️┋ تم وضع الترحيب : \n\n*'..welcome[2]..'*', 1, 'md')
		 database:set('welcome:'..msg.chat_id_,welcome[2])
	end
	...
	if wel then
         send(msg.chat_id_, msg.id_, 1, '☑️┋ <b>الترحيب</b> : \n'..wel, 1, 'html')
    else 
                if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '🎌Welcome msg not saved🎌', 1, 'md')
else 
         send(msg.chat_id_, msg.id_, 1, '☑️┋ <b>لا يوجد ترحيب في المجموعــۿ </b>⚜️', 1, 'html')
end
	end
end
-----------------------------------------------------------------------------------------------------------
       if is_leader(msg) and text:match("^[Ff]wdtoall$") then
          ...
          if database:get("lang:gp:" .. msg.chat_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>ارسل لي الرساله الان</b>📲\n\nللخروج ارسل لي <b>الغاء</b> 📍 ", 1, "html")
          end
        end end
...
----------------------------------------------------------		
        if is_momod(msg.sender_user_id_, msg.chat_id_) and (text:match("^[Ss]etlang (.*)$") or text:match("^ضع لغه (.*)$")) then
          ...
          if langs[2] == "ar" or langs[2] == "عربي" then
            if not database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تـم تغييــر اللغــه عربــي </b>🎐 ", 1, "html")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تـم تغييــر اللغــه عربــي </b>🎐 ", 1, "html")
          ...
          if langs[2] == "en" or langs[2] == "انكلش" then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ *Language Bot is English* ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ *Bot Language is English* ", 1, "md")
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Uu]nlock (.*)$") or text:match("^فتح (.*)$")) and check_user_channel(msg) then
          ...
          if unlockpt[2] == "edit" or unlockpts[2] == "التعديل" then
            if database:get("editmsg" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock edit has been *Inactive* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح التعديل ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("editmsg" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock edit is *Already* inactive 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح التعديل ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unlockpt[2] == "cmd" or unlockpts[2] == "الاوامر" then
            if database:get("bot:cmds" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Case of no answer has been *Inactive* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الاوامر ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:cmds" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Case of no answer is *Already* inactive 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الاوامر ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unlockpt[2] == "bots" or unlockpts[2] == "البوتات" then
            if database:get("bot:bots:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock bot has been *Inactive* 🚀 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح البوتات ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:bots:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock bots is *Already* inactive 🚀  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح البوتات ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unlockpt[2] == "flood" or unlockpts[2] == "التكرار" then
            if database:get("anti-flood:" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock flood has been *Inactive* 🚀  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح التكرار ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("anti-flood:" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock flood is *Already* inactive 🚀  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح التكرار ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unlockpt[2] == "pin" or unlockpts[2] == "التثبيت" then
            if database:get("bot:pin:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock pin has been *Inactive* 🚀  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح التثبيت ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:pin:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock pin is *Already* inactive 🚀 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح التثبيت ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
...
----------------------------------------------------------------------------------------------		
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") then
          ...
          if text:match("^[Ll]ock auto$") and check_user_channel(msg) then
            ...
            if not s and not t then
              ...
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Please Send *Auto-Lock* Time To *Start* 📍 \nFor example:\n14:38", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>ارسل لي وقت بدايه القفل </b>\n\n<b>كذالك وقت فتح المجموعه</b>\n<code>مثلاً : 12:23</code> 🎈 ",  1, "html")
              end
            elseif not database:get("bot:muteall:Time" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock Auto has been *Actived* 🎐\nTo Reset The Time🎈\n Send  *Settime* Command 🏌️", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1," ☑️┋تم قفلالمجموعه بالوقت❗️\n\n🔘- لتغير الوقت ارسل ضع وقت 🎐", 1, "md")
              end
          ...
          if database:get("bot:SetMuteall:start" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) and text:match("^%d+:%d+$") then
            ...
            if h_ >= tonumber(h) and m_ >= tonumber(m) then
              ...
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Please Send *Auto-Lock* \nTime Of The *End* 🎐", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>ارسل لي نهايه الوقت الان</b> 📍 \n<code>مثلا  : 10:47</code>", 1, "html")
              end
            ...
            if text:match("^%d+:%d+") and not text:match(t) then
              ...
              if h_ >= tonumber(h) and m_ >= tonumber(m) then
                ...
                if database:get("lang:gp:" .. msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, "🔰↓ <b> تم قفلالمجموعه من </b>:\n\n الساعه :  " .. start .. "⏱️\n الى الساعه : " .. stop .. " 🎐", 1, "html")
                end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") then
          ...
          if text:match("^[Uu]nlock auto$") and check_user_channel(msg) then
            if database:get("bot:muteall:Time" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Auto-Lock has been *Inactive* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "☑️┋ <code>تم ✅ فتح المجموعه بالوقت </code>✨🎈 ", 1, "html")
              end
              database:del("bot:muteall:Time" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Auto-Lock is *Already* inactive 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <code>تم فتح المجموعه  بالوقت</code> ✨🎋 ", 1, "html")
            end
          end
...
-------------------------------------------------------------------------------------------------------------------------------		
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and text:match("^[Ll]ock gtime (%d+) (%d+) (%d+)$") and check_user_channel(msg) then
          ...
          if 1 <= matches[1] + matches[2] + matches[3] then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock all has been *Enable* for \n`" .. matches[1] .. "` Hours and \n`" .. matches[2] .. "` Minutes and `" .. matches[3] .. "` Seconds ❗️", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b> تم قفلالكل خلال </b>:\n " .. matches[1] .. "ساعه و " .. matches[2] .. " دقیقه و \n " .. matches[3] .. " 🏌️", 1, "html")
            end
          elseif database:get("lang:gp:" .. msg.chat_id_) then
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and text:match("^[Ll]ock gtime (%d+) (%d+)$") and check_user_channel(msg) then
          ...
          if 1 <= matches[1] + matches[2] then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b> تم قفلالمجموعه خلال</b> :\n\n " .. matches[1] .. " ساعه و " .. matches[2] .. " دقيقه🎋", 1, "html")
            end
          elseif database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "⇛ Please *Use* a Number Greater Than 0 ✞", 1, "md")
          else
...
---------------------------------------------------------------------------------------------------------------		
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Ll]ock (.*)$") or text:match("^قفل (.*)$")) and check_user_channel(msg) then
          ...
          if mutept[2] == "all" or mutepts[2] == "الكل" then
            if not database:get("bot:muteall" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock all has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الكل ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:muteall" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock all is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الكل ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "text" or mutepts[2] == "الدردشه" then
            if not database:get("bot:text:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock text has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الدردشه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:text:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock text is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الدردشه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "duplipost" or mutepts[2] == "المشاركه" then
            if not database:get("bot:duplipost:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock duplicate post has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل المشاركه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:duplipost:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock duplicate post is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل المشاركه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "inline" or mutepts[2] == "الانلاين" then
            if not database:get("bot:inline:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock inline has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الانلاين ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:inline:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock inline is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الانلاين ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "post" or mutepts[2] == "البوست" then
            if not database:get("post:lock" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock post has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل البوست ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("post:lock" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock post is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل البوست ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "photo" or mutepts[2] == "الصور" then
            if not database:get("bot:photo:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock photo has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الصور ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:photo:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock photo is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الصور ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "spam" or mutepts[2] == "الكلايش" then
            if not database:get("bot:spam:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock spam has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الكلايش ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:spam:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock spam is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الكلايش ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "video" or mutepts[2] == "الفيديو" then
            if not database:get("bot:video:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock video has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الفيديو ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:video:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock video is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الفيديو ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "selfvideo" or mutepts[2] == "السيلفي" then
            if not database:get("bot:selfvideo:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock self video has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل السيلفي ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:selfvideo:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock self video is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل السيلفي ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "gif" or mutepts[2] == "المتحركه" then
            if not database:get("bot:gifs:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock gif has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل المتحركه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:gifs:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock gif is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل المتحركه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "music" or mutepts[2] == "الاغاني" then
            if not database:get("bot:music:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock music has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الاغاني ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:music:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock music is *Alraedy* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الاغاني ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "voice" or mutepts[2] == "الصوت" then
            if not database:get("bot:voice:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock voice has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الصوت ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:voice:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock voice is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الصوت ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "links" or mutepts[2] == "الروابط" then
            if not database:get("bot:links:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock links has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الروابط ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:links:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock links is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الروابط ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "location" or mutepts[2] == "المواقع" then
            if not database:get("bot:location:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock location has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل المواقع ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:location:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock location is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل المواقع ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "tag" or mutepts[2] == "التاك" then
            if not database:get("tags:lock" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock tag has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل التاك ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("tags:lock" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock tag is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل التاك ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "file" or mutepts[2] == "الفايلات" then
            if not database:get("bot:document:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock file has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الفايلات ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:document:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock file is *Already* actived  📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الفايلات ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "game" or mutepts[2] == "الالعاب" then
            if not database:get("Game:lock" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock game has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الالعاب ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("Game:lock" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock game is *Already* actived  📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الالعاب ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "hashtag" or mutepts[2] == "الهاشتاك" then
            if not database:get("bot:hashtag:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock hastag has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الهاشتاك ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:hashtag:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock hashtag is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الهاشتاك ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "contact" or mutepts[2] == "الاتصال" then
            if not database:get("bot:contact:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock contact has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الاتصال ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:contact:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock contact is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الاتصال ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "webpage" or mutepts[2] == "الويب" then
            if not database:get("bot:webpage:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock webpage has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الويب ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:webpage:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock webpage is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الويب ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "joinmember" or mutepts[2] == "الانضمام" then
            if not database:get("bot:member:lock" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock Join Member has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفلالدخول ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:member:lock" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock Join Member is *Already* actived 📍 ", 1, "md")
            else
          ...
          if mutept[2] == "arabic" or mutepts[2] == "العربيه" then
            if not database:get("bot:arabic:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock arabic has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل العربيه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:arabic:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock arabic is *Already* actived📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل العربيه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "english" or mutepts[2] == "الانكليزيه" then
            if not database:get("bot:english:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock english has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الانكليزيه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:english:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock english is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الانكليزيه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "sticker" or mutepts[2] == "الملصقات" then
            if not database:get("bot:sticker:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock sticker has been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الملصقات ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:sticker:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock sticker is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الملصقات ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "markdown" or mutepts[2] == "الماركدون" then
            if not database:get("markdown:lock" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock markdown has been *Actived* ?? ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الماركدون ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("markdown:lock" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock markdown is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الماركدون ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "tgservice" or mutepts[2] == "اشعارات الدخول" then
            if not database:get("bot:tgservice:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock tgservice has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الاشعارات ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:set("bot:tgservice:mute" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock tgservice is *Already* actived 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋تم قفل الاشعارات ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if mutept[2] == "fwd" or mutepts[2] == "التوجيه" then
            if not database:get("bot:forward:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock forward has been *Actived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋تم قفلالتوجيه ✔️\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Uu]nlock (.*)$") or text:match("^فتح (.*)$")) and check_user_channel(msg) then
          ...
          if unmutept[2] == "all" or unmutept[2] == "gtime" or unmutepts[2] == "الكل" or unmutepts[2] == "`" then
            if database:get("bot:muteall" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock all has been *Inactived* 📍 ", 1, "md")
              else
              ...
              database:set("bot:gtime:say" .. msg.chat_id_, true)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock all is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح الكل ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "text" or unmutepts[2] == "الدردشه" then
            if database:get("bot:text:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock text has been *Inactived*📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح الدردشه ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:text:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock text is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح الدردشه ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "photo" or unmutepts[2] == "الصور" then
            if database:get("bot:photo:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock photo has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح الصور ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:photo:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock photo is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح الصور ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "duplipost" or unmutepts[2] == "المشاركه" then
            if database:get("bot:duplipost:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock duplicate post has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح المشاركه ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:duplipost:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock duplicate post is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح المشاركه ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "spam" or unmutepts[2] == "الكلايش" then
            if database:get("bot:spam:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock spam has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح الكلايش ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:spam:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock spam is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح الكلايش ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "video" or unmutepts[2] == "الفيديو" then
            if database:get("bot:video:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock video has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح الفيديو ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:video:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock video is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1,  "📋┋ تم فتح الفيديو ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "selfvideo" or unmutepts[2] == "السيلفي" then
            if database:get("bot:selfvideo:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock self video has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح السيلفي ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:selfvideo:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock self video is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح السيلفي ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "file" or unmutepts[2] == "الفايلات" then
            if database:get("bot:document:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock file has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الفايلات ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:document:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock file is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الفايلات ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "game" or unmutepts[2] == "الالعاب" then
            if database:get("Game:lock" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock game has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الالعاب ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("Game:lock" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock game is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الالعاب ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "inline" or unmutepts[2] == "الانلاين" then
            if database:get("bot:inline:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock inline has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الانلاين ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:inline:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock inline is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الانلاين ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "post" or unmutepts[2] == "البوست" then
            if database:get("post:lock" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock post has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح البوست ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("post:lock" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock post is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح البوست ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "markdown" or unmutepts[2] == "الماركدون" then
            if database:get("markdown:lock" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock markdown has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الماركدون ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("markdown:lock" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock markdown is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الماركدون ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "gif" or unmutepts[2] == "المتحركه" then
            if database:get("bot:gifs:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock gif has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح المتحركه ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:gifs:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock gif is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح المتحركه ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "music" or unmutepts[2] == "الاغاني" then
            if database:get("bot:music:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock music has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الاغاني ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:music:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock music is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الاغاني ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "voice" or unmutepts[2] == "الصوت" then
            if database:get("bot:voice:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock voice has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الصوت ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:voice:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock voice is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الصوت ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "links" or unmutepts[2] == "الروابط" then
            if database:get("bot:links:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock links has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الروابط ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:links:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock link is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الروابط ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "location" or unmutepts[2] == "المواقع" then
            if database:get("bot:location:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock location has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح المواقع ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:location:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock location is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح المواقع ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "tag" or unmutepts[2] == "التاك" then
            if database:get("tags:lock" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock tag has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح التاك ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("tags:lock" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock tag is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح التاك ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "hashtag" or unmutepts[2] == "الهاشتاك" then
            if database:get("bot:hashtag:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock hashtag has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الهاشتاك ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:hashtag:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock hashtag is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الهاشتاك ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "contact" or unmutepts[2] == "الاتصال" then
            if database:get("bot:contact:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock contact has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الاتصال ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:contact:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock contact is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الاتصال ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "webpage" or unmutepts[2] == "الويب" then
            if database:get("bot:webpage:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock webpage has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الويب ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:webpage:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock webpage is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الويب ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          ...
          if unmutept[2] == "joinmember" or unmutepts[2] == "الانضمام" then
            if database:get("bot:member:lock" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock Join Member has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الدخول ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:member:lock" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock Join Member is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الدخول ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "english" or unmutepts[2] == "الانكليزيه" then
            if database:get("bot:english:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock english has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الانكليزي ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:english:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock english is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الانكليزي ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "tgservice" or unmutepts[2] == "اشعارات الدخول" then
            if database:get("bot:tgservice:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock tgservice has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الاشعارات ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:tgservice:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Lock tgservice is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الاشعارات ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
          if unmutept[2] == "sticker" or unmutepts[2] == "الملصقات" then
            if database:get("bot:sticker:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock sticker has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الملصقات ✓\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:sticker:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock sticker is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح الملصقات ✓\n☑️┋ايديك  ↭ ("..msg.sender_user_id_..")\n‏", 1, "md")
            end
          end
          if unmutept[2] == "fwd" or unmutepts[2] == "التوجيه" then
            if database:get("bot:forward:mute" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock forward has been *Inactived* 📍  ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح التوجيه ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
              end
              database:del("bot:forward:mute" .. msg.chat_id_)
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Lock forward is *Already* inactived 📍  ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📋┋ تم فتح التوجيه ✓\n🔘┋رتبتك ↭ `"..tmmatthew1(msg).."`\n☑️┋ايديك  ↭ (`"..msg.sender_user_id_.."`)\n‏", 1, "md")
            end
          end
...
----------------------------------------------------------------------------------------------------------------		
	   ...
	   local sensspam = {
          ...
          if 40 > tonumber(sensspam[2]) then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  Enter a number *Greater* than `40` 🎈 ", 1, "md")
            else
...
--------------------------------------------------------------------------------------------------------------		
        if is_momod(msg.sender_user_id_, msg.chat_id_) and (text:match("^[Cc]lean (.*)$") or text:match("^مسح (.*)$"))  and check_user_channel(msg) then
          ...
          if txt[2] == "banlist" or txts[2] == "المحظورين" and idf:match("-100(%d+)") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  *Banlist* Has Been Cleared 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تم √ مسح المحظورين </b>🎋", 1, "html")
            end
          end
          if is_sudo(msg) and (txt[2] == "banalllist" or txts[2] == "قائمه العام") then
            database:del("bot:gban:")
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ *Banalllist* Has Been Cleared 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تم √ مسح المحظورين عام </b>♩", 1, "html")
            end
          end
          ...
          if txt[2] == "deleted" or txts[2] == "الحسابات المحذوفه" and idf:match("-100(%d+)") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  All *Delete Account* has been *Removed* 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تم √ طرد جميع الحسابات المحذوفه </b>🎋", 1, "html")
            end
          end
          if txt[2] == "blocked" or txts[2] == "حظر المجموعه" and idf:match("-100(%d+)") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ If You Want Cleaning Group Blocked List📍  \n Send The Number 1 📍 \nElseif You Want Inviteing Group Blocked List📍 \n Send The Number 2 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <code>اهــــــــلاً عزيزي ...؟</code>🕵🏻\n\n🅾️↓ <b> اذا اردت مسح المحضورين في المجموعه ارسل لي رقم= 1</b>\n\n🚸↓ <b>اذا اردت اضافتهم للمجموعه ارسل لي رقم= 2</b> 🎋❗️",  1, "html")
            end
            ...
            if database:get("lang🇬🇵" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  All *Bots* has been *Removed* 📍 ", 1, "md")
            else
          ...
          if is_owner(msg.sender_user_id_, msg.chat_id_) and (txt[2] == "modlist" or txts[2] == "الادمنيه" and idf:match("-100(%d+)")) then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  *Modlist* has been Cleared 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تـــم √ مسح الادمنيه </b>🎋📍 ", 1, "html")
            end
            database:del("bot:momod:" .. msg.chat_id_)
          end
          if txt[2] == "ownerlist" or txts[2] == "المدراء" and idf:match("-100(%d+)") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  *Owner List* has been Cleared 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تم ✅ مسح المدراء </b>🏌️", 1, "html")
            end
            database:del("bot:owners:" .. msg.chat_id_)
          end
          if is_leader(msg) and (txt[2] == "sudolist" or txts[2] == "المطورين") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  *Sudo List* has been Cleared 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <code>تم √ مسح كل المطورين</code> 🕵🏽📍 ", 1, "html")
            end
            local hash = "Bot:SudoUsers"
            local list = database:smembers(hash)
            for k, v in pairs(list) do
          ...
          if is_leader(msg) and (txt[2] == "adminlist" or txts[2] == "ادمنيه البوت") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  *Admin List* has been Cleared 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تم ✅ مسح ادمنية البوت 📍 </b>", 1, "html")
            end
          ...
          if txt[2] == "viplist" or txts[2] == "الاعضاء المميزين" and idf:match("-100(%d+)") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  *VIP Members* list has been Cleared 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تم ✅ مسح المميزين</b> 💔🎈", 1, "html")
            end
          ...
          if txt[2] == "filterlist" or txts[2] == "قائمه المنع" and idf:match("-100(%d+)") then
            ...
            database:del(hash)
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ *Filterlist* has been Cleared 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <code>تم ✔ مسح قائمة المنع </code>✞", 1, "html")
            end
          end
          if txt[2] == "mutelist" or txts[2] == "المكتومين" and idf:match("-100(%d+)") then
            database:del("bot:muted:" .. msg.chat_id_)
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  *MutedUsers* list has been Cleared 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تم √ مسح المكتومين</b> 🎋🎈", 1, "html")
            end
          end
        end
        ...
        if database:get("CleanBlockList" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then
          ...
          if text:match("^1$") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ All *Removed User* has been *Released* ✞", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تم ✅ مسح الاعظاء المحضورين في المجموعه </b>🎋🎈", 1, "html")
            end
          elseif text:match("^2$") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ All *Removed User* has been *Invited* ✞", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تم ✅ اضافه المحظورين الى المجموعه📍</b> ", 1, "html")
            end
          end
        end end
---------------------------------------------------------------------------------------------------------		
          ...
          elseif (text:match("^الاعدادات خاص$")) and is_admin(msg.sender_user_id_) and idf:match("-100(%d+)") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋  *Settings* has been \n*Sent* to your Pv 🎌", 1, "md")
            else
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") then
          if (text:match("^[Ss]etrules$") or text:match("^ضع قوانين$")) and check_user_channel(msg) then
		   if not database:get('lock:add'..msg.chat_id_) then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ Plese *Send* Group Rules 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "📜┇  <code>حسناا عزيزي ارسل القوانين</code> ", 1, "html")
            end end
          end
          if (text:match("^[Dd]elrules$") or text:match("^مسح القوانين$")) and check_user_channel(msg) then
		   if not database:get('lock:add'..msg.chat_id_) then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ *Group Rules* Has Been *Cleared* 📍 ", 1, "md")
            else
...
------------------------------------------------------------------------------------		
		if text:match("^[Ss]etphoto$") or text:match("^ضع صوره") and is_owner(msg.sender_user_id_, msg.chat_id_) then
         ...
         if database:get("lang:gp:" .. msg.chat_id_) then
      send(msg.chat_id_, msg.id_, 1, '☑️┋ *Please send a photo noew🎣*', 1, 'md')
         else 
           send(msg.chat_id_, msg.id_, 1, '☑️┋ <b>قم بارسال صوره الان 📤</b>', 1, 'html')
          end
                end end
--------------------------------------------------------------------------------------------------------
      if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and text:match("^ضع اسم (.*)$") or text:match("^[Rr]ename (.*)$") and check_user_channel(msg) then
	   if not database:get('lock:add'..msg.chat_id_) then
          ...
          if database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "☑️┋  Group name has been *Changed* ❗️", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "☑️┋ تم تغييــر اسم المجموعــه 📃", 1, "md")
          end
        end end
----------------------------------------------------------------------------------------------		
        if is_admin(msg.sender_user_id_) and text:match("^[Ll]eave (-%d+)$") or text:match("^مغادرة (-%d+)$")  then
		 if not database:get('lock:add'..msg.chat_id_) then
          local txt = {
            string.match(text, "^([Ll]eave) (-%d+)$")
          }
		  local txt = {
            string.match(text, "^(ممغادرةة) (-%d+)$")
          }
          local leavegp = function(extra, result)
            if result.id_ then
              ...
              if database:get("lang:gp:" .. result.id_) then
                send(result.id_, 0, 1, "☑️┋ *The robot for some reason left the group *", 1, "html")
              else
                send(result.id_, 0, 1, "☑️┋ <b> تم اخراج البوت 🎐</b>\n\n• <code>راسل المطور للتفعيل</code> 📋", 1, "html")
              end
          ...
          local adding = function(extra, result)
            ...
            if database:get("bot:enable:" .. msg.chat_id_) then
              if not database:get("lang🇬🇵" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "🗂┇ <b>تـم تفـعيل المجموعه بنجاح</b> " .. (chat and chat.title_ or "") .. "\n", 1, "html")
              else
              ...
              send(bot_owner, 0, 1, "☑️┋ <b>تم اضافه مجموعه جديده</b>\n☑️┋ <code>معلومات عن المطور 📪</code>\n☑️┋<b> ايدي </b> : <code>" .. msg.sender_user_id_ .. "</code>\n☑️┋ <code>الاسم</code> : " .. fname .. " " .. lname .. "\n🎫┋ <code>المعرف</code> : " .. username .. "\n🎫┋ <b>ايدي المجموعه </b>: <code>" .. msg.chat_id_ .. "</code>\n🎫┋<b> لاخراج البوت ارسل </b>\n•• <code>مغادرة " .. msg.chat_id_ .. "</code>", 1, "html")
              database:set("bot:enable:" .. msg.chat_id_, true)
        ...
        if is_sudo(msg) and idf:match("-100(%d+)") and text:match("^[Rr]em$") or text:match("^تعطيل$") then
          ...
          if not database:get("bot:enable:" .. msg.chat_id_) then
            if database:get("lang🇬🇵" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "❌┇ <b>تـم تعطيل المجموعه بنجاح</b>\n" .. (chat and chat.title_ or "") .. "\n", 1, "html")
            end
          else
            if database:get("lang🇬🇵" .. msg.chat_id_) then
            ...
            local send_to_bot_owner = function(extra, result)
              ...
              send(v, 0, 1, "☑️┋ تم تعطيل المجموعه :\n\n معلومات حول المطور : \n☑️┋ الاسم : " .. fname .. " " .. lname .. "\n☑️┋ المعرف : " .. username .. "\n☑️┋ ايدي المجموعه : <code>" .. msg.chat_id_ .. "</code>\n☑️┋ اسم المجموعه : " .. (chat and chat.title_ or ""), 1, "html")
            end
 ...
 if is_admin(msg.sender_user_id_) and text:match("^[Dd]ata$") or text:match("^معلوماتي$")  and msg.reply_to_message_id_ == 0 then
  if not database:get('lock:add'..msg.chat_id_) then
          local get_data = function(extra, result)
            ...
            if #list == 0 then
              text = "🚦↓ معلوماتك هيه〽️:\n\n💭┋ <b>اسمــك</b>: \n" .. name .. "\n\n♒️┋ <b>معرفك</b> : " .. susername .. "\n\n☑️ <b> لم تضف اي مجموعه</b>🎐"
            end
            send_large_msg(msg.chat_id_, msg.id_, 1, text, 1, "html")
          end
          if database:get("bot:reloadingtime") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              text = "☑️┋  Bot is in a <b>State Reloading</b> 📍 "
            else
              text = "☑️┋ تم تحديث البوت 🎐 "
            end
            send(msg.chat_id_, msg.id_, 1, text, 1, "html")
          else
          ...
          do
            local data_by_reply = function(extra, result)
              if is_admin(result.id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "☑️┋<b> العضو ليس من المطورين</b>📍 ", 1, "html")
              end
            end
...
-----------------------------------------------------------------------------------------------------		
        if is_admin(msg.sender_user_id_) and text:match("^[Jj]oin (-%d+)") or text:match("^ادخل (-%d+)")  then
          ...
          local JoinById = function(extra, result)
            send(msg.chat_id_, msg.id_, 1, "☑️┋ تم اضافــة المجموعــه : \n\n " .. result.title_ .. " 📭", 1, "md")
...
local s2a = "☑️┋ تم ارسال الاذاعه الى:\n(* GP *)من الاعضاء\n‏"
...
send(msg.chat_id_, msg.id_, 1,'☑️┋ تم رفع جميع الادمنيه ✔️\n‏', 1, 'md')
end
      ...
      if msg.chat_id_:match("^-100") then
       ...
       chat_id_ = msg.chat_id_,
        from_message_id_ = 0,
         ...
         pm ='☑️┋ تم مسح <b>('..matches[2]..')</b> رسالۿ'
       send(msg.chat_id_, msg.id_, 1, pm, 1, 'html')
         end
...
------------------------------------------------------------------------------------------		
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and msg.reply_to_message_id_ ~= 0 and (text:match("^[Pp]in$") or text:match("^تثبيت$")) and check_user_channel(msg) then
		 if not database:get('lock:add'..msg.chat_id_) then
          ...
          if database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "☑️┋ The Message has been *Pinned* 📍 ", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "☑️┋ <b>تم تثبــيت الرسالــۿ 💌🎈</b>", 1, "html")
          end
        end end
------------------------------------------------------------
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Uu]npin$") or text:match("^الغاء تثبيت$")) and check_user_channel(msg) then
		 if not database:get('lock:add'..msg.chat_id_) then
          unpinmsg(msg.chat_id_)
          if database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "☑️┋  The Message has been *UnPinned* 📍 ", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "☑️┋ <b> تم الغاء تثبيــت الرسالــۿ </b>🎌", 1, "html")
          end
        end end
	------------------------------------------------------	
	if text == 'ارسال نسخه' and is_leader(msg) then
        if not database:get('lock:add'..msg.chat_id_) then
tdcli.sendDocument(SUDO, 0, 0, 1, nil, './matthew1.lua', dl_cb, nil)
send(msg.chat_id_, msg.id_, 1, '☑️┋ تم ارسال نسخه الى خاص البوت ✔️', 1, 'md')
end
end
---------------------------------------------------------------
  ...
  if not database:get('lock:add'..msg.chat_id_) then
dofile('matthew1.lua')
send(msg.chat_id_, msg.id_, 1,'☑️┋ تم تحديث البوت ✔️', 1, 'md')
end
 end
 -------------------------------------------------
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Rr]epin$") or text:match("^اعادة تثبيت$")) and check_user_channel(msg) then
		 if not database:get('lock:add'..msg.chat_id_) then
          ...
          if pin_id then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "☑️┋ The Message has been *RePinned* 📍 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "☑️┋ <b> تم √ اعاده تثبــيت الرسالــۿ</b> 🎐", 1, "html")
            end
            pinmsg(msg.chat_id_, pin_id, 0)
          elseif database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "☑️┋   Message Pinned the former was *not Found* 📍 ", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "☑️┋ <b> لا ✘ توجد رسالۿ مثبته </b>📬", 1, "html")
          end
        end end
-----------------------------------------------------------------------------------------
        if (idf:match("-100(%d+)") or is_momod(msg.sender_user_id_, msg.chat_id_)) and text:match("^موقعي$") or text:match("^[Mm]e$") and msg.reply_to_message_id_ == 0 and check_user_channel(msg) then
		  ...
		  local msgs = database:get("msgs:"..msg.sender_user_id_..":"..msg.chat_id_)
            ...
            elseif is_owner(result.id_, msg.chat_id_) then
              ...
              matthew13 = "المدير 🍂"
            elseif is_momod(result.id_, msg.chat_id_) then
              matthew14 = "Group Admin 🎌"
              matthew13 = "ادمن المجموعه🎌"
            elseif is_vipmem(result.id_, msg.chat_id_) then
              matthew14 = "VIP Member ⚔️"
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and (text:match("^[Gg]view$") or text:match("^عدد المشاهدات$")) then
          ...
          if database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "☑️┋ Plese *Forward* your Post 📍 : ", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "☑️┋ ارسل لي توجيــۿ  للمنشــور 🎈: ", 1, "md")
          end
        end end
--------------------------------------------------------
...
if text == "ماثيو" or text == "محمد قيس" then
        	if not database:get('lock:add'..msg.chat_id_) then
local matthew1 = {" 😻مطوري العشق","تٰـہٰٖفٰـہٰٖضٰـہٰٖل كٰـہٰٖوٰل" }
send(msg.chat_id_, msg.id_, 1,''..matthew1[math.random(#matthew1)]..'', 1, 'md')
end
end

if text == "محمد الميساني" or text == "عمار الذيب"or text == "تيسير"or text == "جعفر صادق" or text == "كيناي" or text == "فايدر"or text == "ميمو" then
        	if not database:get('lock:add'..msg.chat_id_) then
local matthew1 = {"اموت ع ربه🌝"," اموت علي💗" }
send(msg.chat_id_, msg.id_, 1,''..matthew1[math.random(#matthew1)]..'', 1, 'md')
end
end
----------------------------------------------------------	   
